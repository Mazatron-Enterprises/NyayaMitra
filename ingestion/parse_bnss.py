...
INPUT_FILE = Path(
    "data/extracted/statutes/bhartiya-nagrik-suraksha-sanhita-2023.txt"
)
...
def main():
    ...
    for i, match in enumerate(section_matches):
        ...
        sections.append(
            {
                "document_id": f"bnss_{parsed['section_number']}",
    ...
    assert lookup[1]["section_title"] == "Short title, extent and commencement"
    assert lookup[358]["section_title"] == "Power to proceed against other persons appearing to be guilty of offence"
